	...
	*/
	...
	class LSystem
	{
		...
		public:
			 ...
			 */
            vector<pair<std::string, double>> const& get_replacement(char c) const; //
		...
		protected:
		         ...
		         */
			std::set<char> alphabet; // voordien een set
			...
			double angle;
		         ...
		         */
			map<char, vector<std::pair<std::string, double>>> replacementrules;
